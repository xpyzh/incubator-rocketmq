...
public class BrokerController {
    ...
    //管理每一个consumerGroup每一个topic的offset
    ...
    public void registerProcessor() {
        /**
         * SendMessageProcessor(核心),处理客户端发送的消息
         */
        ...
        //注册同样的一批处理客户端发送message的处理器，只不过是在vip端口注册
        ...
        /**
         * ConsumerManageProcessor(核心),处理客户端消费消息
         */
